...
const updateSettingsValidator = [
  ...
  body('timezone').optional().isString().trim().withMessage('Invalid timezone'),
  body('auto_backup').optional().isBoolean().withMessage('auto_backup must be boolean'),
...
const updateNotificationSettingsValidator = [
  ...
  body('whatsapp_enabled').optional().isBoolean().withMessage('whatsapp_enabled must be boolean'),
  ...
  body('email_for_tasks').optional().isBoolean().withMessage('email_for_tasks must be boolean'),
...
export { updateSettingsValidator, updateNotificationSettingsValidator };
