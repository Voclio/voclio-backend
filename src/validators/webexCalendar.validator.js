...
export const createMeetingValidation = [
  ...
  body('excludePassword').optional().isBoolean().withMessage('Exclude password must be boolean'),
  ...
  body('hostEmail').optional().isEmail().withMessage('Host email must be a valid email address'),

  body('siteUrl').optional().isURL().withMessage('Site URL must be a valid URL')
];
