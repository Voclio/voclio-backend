...
const getCalendarEventsValidator = [
  ...
  query('end_date').notEmpty().isISO8601().withMessage('end_date must be a valid ISO 8601 date')
];
...
export { getCalendarEventsValidator, getMonthCalendarValidator, getDayEventsValidator };
